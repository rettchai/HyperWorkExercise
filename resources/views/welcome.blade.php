...
<body class="antialiased">
    <div
        ...
        <a href="{{route('passport.login')}}" >
            <button class="btn btn-primary"> login rmutr account</button>
        </a>
        <a href="{{route('google.login')}}" >
            <button class="btn btn-primary"> login google account</button>
        </a>
        <a href="{{route('facebook.login')}}" >
            <button class="btn btn-primary"> login faccebook account</button>
        </a>
        @if (Route::has('login'))
